	...
	echo $usuario -> obtener_nombre();
		...
		if (isset ($conexion)) {
			try{
				...
				$nombrecito=$usuario->obtener_nombre();
				$emilio = $usuario -> obtener_email();
				$contrasenna = $usuario -> obtener_password();
				//Para enlazar parámetro.
				$sentencia -> bindParam(':nombre', $nombrecito, PDO::PARAM_STR);
				$sentencia -> bindParam(':email', $emilio, PDO::PARAM_STR);
				$sentencia -> bindParam(':password', $contrasenna , PDO::PARAM_STR);
